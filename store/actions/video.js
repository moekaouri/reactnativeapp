  ...
  return async (dispatch) => {
    ...
    try {
      const response = await fetch(
        'https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&q=justin&type=video&key=AIzaSyDzbDPPR3p9rU4YRPEhaq_WMp7W60OvLJQ'
      );
      //another api key: AIzaSyAZptDJc5ACc2aBxArswatOPc53BRnlwrk
      //another api key: AIzaSyBPGRmV9Kt9ptSki8hqPKi9VPlmWOc6txM
